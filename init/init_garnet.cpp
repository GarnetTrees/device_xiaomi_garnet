...
void vendor_load_properties() {
    ...
    if (region == "IN") {
        ...
        if (sku == "garnet") {
            brand = "Redmi";
            description = "garnet_in-user 15 AQ3A.240912.001 OS2.0.4.0.VNRINXM release-keys";
            fingerprint = "Redmi/garnet_in/garnet:15/AQ3A.240912.001/OS2.0.4.0.VNRINXM/release-keys";
            marketname = "Redmi Note 13 Pro 5G";
            model = "2312DRA50I";
        } else {
            brand = "POCO";
            description = "garnetp_in-user 15 AQ3A.240912.001 OS2.0.4.0.VNRINXM release-keys";
            fingerprint = "POCO/garnetp_in/garnet:15/AQ3A.240912.001/OS2.0.4.0.VNRINXM/release-keys";
